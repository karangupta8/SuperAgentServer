...
class Settings(BaseSettings):
    ...
    # Adapter Settings
    MCP_ENABLED: bool = Field(default=True, description="Enable MCP adapter")
    WEBHOOK_ENABLED: bool = Field(default=True, description="Enable webhook adapter")
    A2A_ENABLED: bool = Field(default=True, description="Enable A2A adapter")
    ACP_ENABLED: bool = Field(default=True, description="Enable ACP adapter")
